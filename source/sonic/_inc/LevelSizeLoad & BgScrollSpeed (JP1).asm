...
LevelSizeLoad:
		moveq	#0,d0
		move.b	d0,($FFFF8740).w
		move.b	d0,($FFFF8741).w
		move.b	d0,($FFFF8746).w
		move.b	d0,($FFFF8748).w
...
LevelSizeArray:
		...
		dc.w $0004, $0000, $2FFF, $0000, $0320, $0060
		; Secret
		dc.w $0004, $0000, $3FFF, $FF00, $0800, $0060
		dc.w $0004, $0000, $3FFF, $FF00, $0800, $0060
		dc.w $0004, $0000, $3FFF, $FF00, $0800, $0060
		dc.w $0004, $0000, $3FFF, $FF00, $0800, $0060
...
; ---------------------------------------------------------------------------
StartLocArray:
		include	"source/sonic/_inc/Start Location Array - Levels.asm"
...
BgScroll_Index:	dc.w BgScroll_GHZ-BgScroll_Index, BgScroll_LZ-BgScroll_Index
		...
		dc.w BgScroll_End-BgScroll_Index, BgScroll_Secret-BgScroll_Index
; ===========================================================================
...
BgScroll_Secret:
		move.l	#$1000000,(v_bgscreenposx).w
		move.l	#$1000000,(v_bgscreenposy).w
		rts

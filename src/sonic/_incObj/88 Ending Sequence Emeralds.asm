...
ECha_Main:	; Routine 0
		cmpi.b	#$C,(v_player+obFrame).w ; this isn't `fr_Wait1`: `v_player` is Object 88, which has its own frames
...
ECha_CreateEms:
	...
	ECha_LoadLoop:
		...
		move.w	#v_spritequeue+$80,obPriority(a1)
		move.w	obX(a0),echa_origX(a1)
		move.w	obY(a0),echa_origY(a1)
		clr.b	obFrame(a1)
		move.b	d3,obAngle(a1)
		addi.b	#$100/7,d3	; angle between each emerald
		lea	$40(a1),a1

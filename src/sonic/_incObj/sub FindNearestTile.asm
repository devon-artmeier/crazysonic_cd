...
FindNearestTile:
		lea	(levelLayout).w,a1	; Get row address
		move.w	d2,d0
		lsr.w	#5,d0
		andi.w	#$3C,d0
		move.w	(a1,d0.w),d0
		
		move.w	d3,d1			; Chunk X offset
		lsr.w	#3,d1
		move.w	d1,d4			; Layout X offset
		lsr.w	#4,d1
		
		add.w	d1,d0			; Get block address
		movea.w	d0,a1
		moveq	#0,d1
		move.b	(a1),d1
		add.w	d1,d1
		move.w	ChunkColAddrs(pc,d1.w),d1
		move.w	d2,d0
		andi.w	#$70,d0
		add.w	d0,d1
		andi.w	#$E,d4
		add.w	d4,d1
		add.l	(v_levelchunks).w,d1
		movea.l	d1,a1
		rts

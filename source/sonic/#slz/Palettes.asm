...
ptr_Pal_SLZ:		palp	Pal_SLZ,v_pal_dry+$20,$30	; 4 - LZ
			even

palid_Sonic:		equ (ptr_Pal_Sonic-PalPointers)/8
palid_Level:		equ (ptr_Pal_SLZ-PalPointers)/8
palid_LZSonWater:	equ (ptr_Pal_Sonic-PalPointers)/8
palid_SBZ3SonWat:	equ (ptr_Pal_Sonic-PalPointers)/8
palid_LZWater:		equ (ptr_Pal_SLZ-PalPointers)/8
palid_SBZ3Water:	equ (ptr_Pal_SLZ-PalPointers)/8
palid_SBZ2:		equ (ptr_Pal_SLZ-PalPointers)/8
palid_SBZ3:		equ (ptr_Pal_SLZ-PalPointers)/8

Pal_Sonic:	incbin	"source/sonic/palette/Sonic.bin"
Pal_SLZ:	incbin	"source/sonic/palette/Star Light Zone.bin"

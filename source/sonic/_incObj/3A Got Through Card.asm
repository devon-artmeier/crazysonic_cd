...
loc_C61A:
		cmpi.b	#$E,(v_objspace+$6C0+obRoutine).w
		beq.s	loc_C610
		cmpi.b	#4,obFrame(a0)
		bne.s	loc_C5FE
...
Got_NextLevel:	; Routine $A
		...
		add.w	d1,d0
		moveq	#1,d1
		move.b	LevelOrder(pc,d0.w),d2 ; load level from level order array
		cmp.b	(v_zone).w,d2
		beq.s	.SetZone
		moveq	#-1,d1
...
VBla_08A:
		move.w	d1,(f_restart).w ; restart level

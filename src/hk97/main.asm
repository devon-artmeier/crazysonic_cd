...
; -------------------------------------------------------------------------
	...
	include	"src/hk97/data_labels.inc"
...
Art_Cutscene:
	incbin	"src/hk97/data/cutsceneart.kos"
	even
Map_Cutscene:
	incbin	"src/hk97/data/cutscenemap.eni"
	even
Art_GameOver:
	incbin	"src/hk97/data/gameover.kos"
	even
Pal_BossBG:
	incbin	"src/hk97/data/bosspal.bin"
	even
Art_BSOD:
	incbin	"src/hk97/data/bsod_art.kos"
	even
Pal_BSOD:
	incbin	"src/hk97/data/bsod_palette.bin"
	even

...
; -------------------------------------------------------------------------
	...
	include "src/sonic/#end/Level Events.asm"
	include "src/sonic/#end/Animate.asm"
...
Map_Lamp:
	...
	include	"src/sonic/_incObj/87 Ending Sequence Sonic.asm"
	include "src/sonic/_anim/Ending Sequence Sonic.asm"
	include	"src/sonic/_incObj/88 Ending Sequence Emeralds.asm"
	include	"src/sonic/_incObj/89 Ending Sequence STH.asm"
Map_ECha:
	include	"src/sonic/_maps/Ending Sequence Emeralds.asm"
Map_ESth:
	include	"src/sonic/_maps/Ending Sequence STH.asm"
	include	"src/sonic/_incObj/8B Try Again & End Eggman.asm"
	include "src/sonic/_anim/Try Again & End Eggman.asm"
	include	"src/sonic/_incObj/8C Try Again Emeralds.asm"
Map_EEgg:
	include	"src/sonic/_maps/Try Again & End Eggman.asm"
	include	"src/sonic/_incObj/8A Credits.asm"
Map_Cred:
	include	"src/sonic/_maps/Credits.asm"
...
; -------------------------------------------------------------------------
	...
	include "src/sonic/#end/Palettes.asm"
	include "src/sonic/#end/Debug List.asm"
	include "src/sonic/#end/Level Headers.asm"
	include "src/sonic/#end/Pattern Load Cues.asm"
...
Level_Act3:
Level_Act4:
	incbin	"src/sonic/levels/ending.bin"
	even
...
ObjPos_Act3:
ObjPos_Act4:
	incbin	"src/sonic/objpos/ending.bin"
	even
	dc.w $FFFF, 0, 0
...
RingPos_Act3:
RingPos_Act4:
	incbin	"src/sonic/ringpos/ending.bin"
	even
...
Nem_Stalk:
	...
	even
Nem_EndEm:
	incbin	"src/sonic/artnem/Ending - Emeralds.bin"
	even
Nem_EndFlower:
	incbin	"src/sonic/artnem/Ending - Flowers.bin"
	even
Nem_EndStH:
	incbin	"src/sonic/artnem/Ending - StH Logo.bin"
	even
Nem_TryAgain:
	incbin	"src/sonic/artnem/Ending - Try Again.bin"
	even
Nem_CreditText:
	incbin	"src/sonic/artnem/Ending - Credits.bin"
	even

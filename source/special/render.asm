...
InitGfxOperation:
	...
	move.w	#%110,GFX_CTRL.w				; 32x32 stamps, 4096x4096 map, not repeated
	...
	move.b	MEMORY_MODE.w,d0				; Set to overwrite mode
	andi.b	#%11100111,d0
	ori.b	#%00010000,d0
	move.b	d0,MEMORY_MODE.w
...
RunNextGfxOp:
	...
	move.w	#IMG_HEIGHT,GFX_HEIGHT.w			; Image buffer height

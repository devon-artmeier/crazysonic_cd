...
.0:
	...
	even
Map_MrRogersFire:
	include	"src/sonic/_incObj/Mr Rogers/Fire Mappings.asm"
	even
Map_MrRogersFist:
	include	"src/sonic/_incObj/Mr Rogers/Fist Mappings.asm"
	even
Pal_MrRogers:
	incbin	"src/sonic/_incObj/Mr Rogers/Palette.bin"
	even

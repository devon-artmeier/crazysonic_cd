...
loc_160E:
		...
		move.l	d0,($FFFF86E4).w
		move.l	d0,($FFFF86E8).w
		move.l	d0,($FFFF86EC).w
		move.l	d5,($FFFF86F0).w
		move.l	d6,($FFFF86F4).w
...
sub_1642:
		...
		move.w	#9,($FFFF86FA).w
		moveq	#0,d0
		move.w	($FFFF8684).w,d0
		addi.w	#$120,($FFFF8684).w
		bra.s	loc_1676
...
loc_1676:
		...
		move.l	($FFFF86E4).w,d0
		move.l	($FFFF86E8).w,d1
		move.l	($FFFF86EC).w,d2
		move.l	($FFFF86F0).w,d5
		move.l	($FFFF86F4).w,d6
		lea	(v_ngfx_buffer).w,a1
...
loc_16AA:
		...
		move.l	a3,(v_ptrnemcode).w
		move.l	d0,($FFFF86E4).w
		move.l	d1,($FFFF86E8).w
		move.l	d2,($FFFF86EC).w
		move.l	d5,($FFFF86F0).w
		move.l	d6,($FFFF86F4).w
...
QuickPLC:
		movea.l	(v_plcindex).w,a1 ; load the PLC index
		add.w	d0,d0
		move.w	(a1,d0.w),d0
		lea	(a1,d0.w),a1
	...
	Qplc_Loop:
		...
		ori.w	#$4000,d0
		swap	d0
		move.l	d0,(VDP_CTRL).l ; converted VRAM address to VDP format

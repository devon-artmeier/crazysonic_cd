...
Pal_LZCyc1:	incbin	"source/sonic/palette/Cycle - LZ Waterfall.bin"
Pal_LZCyc2:	incbin	"source/sonic/palette/Cycle - LZ Conveyor Belt.bin"
Pal_LZCyc3:	incbin	"source/sonic/palette/Cycle - LZ Conveyor Belt Underwater.bin"
Pal_SBZ3Cyc1:	incbin	"source/sonic/palette/Cycle - SBZ3 Waterfall.bin"

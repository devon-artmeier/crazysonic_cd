...
; -------------------------------------------------------------------------
	...
	include	"source/hk97/actors/player.asm"
	include	"source/hk97/actors/red1.asm"
	include	"source/hk97/actors/red2.asm"
	include	"source/hk97/actors/red3.asm"
	include	"source/hk97/actors/boss.asm"
...
PCM_PlayerShoot:
	incbin	"source/hk97/sounds/player_shoot.pcm"
PCM_PlayerShoot_End:
	even
PCM_EnemyDie:
	incbin	"source/hk97/sounds/enemy_die.pcm"
PCM_EnemyDie_End:
	even
PCM_PlayerDie:
	incbin	"source/hk97/sounds/player_die.pcm"
PCM_PlayerDie_End:
	even
PCM_Bomb:
	incbin	"source/hk97/sounds/bomb.pcm"
PCM_Bomb_End:
	even
PCM_Blank:
	dcb.b	$20, 0

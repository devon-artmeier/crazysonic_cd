...
; -------------------------------------------------------------------------
	...
	include	"src/special/map.inc"
	include	"src/special/sub_variables.inc"
...
; -------------------------------------------------------------------------
	...
	include	"src/special/shared.inc"
...
; -------------------------------------------------------------------------
	...
	include	"src/special/object.asm"
	include	"src/special/render.asm"
	include	"src/special/map.asm"
	include	"src/libraries/Kosinski Decompression.asm"
	include	"src/special/math.asm"
	
; -------------------------------------------------------------------------
; Objects
; -------------------------------------------------------------------------

	include	"src/special/objects/bus.asm"
	include	"src/special/objects/person.asm"
	include	"src/special/objects/sign.asm"
	include	"src/special/objects/tree.asm"
	include	"src/special/objects/arrow.asm"
	include	"src/special/objects/destination.asm"
...
Stamps:
	incbin	"src/special/data/stamps.kos"
	even
Map:
	incbin	"src/special/data/map.kos"
	even
ObjectMap:
	incbin	"src/special/data/objects.bin"
	even
...
PCM_Scream:
	incbin	"src/special/pcm/scream.pcm"
PCM_ScreamLoop:
	dcb.b	$20, $00
	dcb.b	$20, $FF
	even
...
PCM_Sign:
	incbin	"src/special/pcm/sign.pcm"
PCM_SignLoop:
	dcb.b	$20, $00
	dcb.b	$20, $FF
	even

...
; -------------------------------------------------------------------------
	...
	include	"src/sonic/_incObj/7E Special Stage Results.asm"
	include	"src/sonic/_incObj/7F SS Result Chaos Emeralds.asm"
...
Map_SSRC:
	include	"src/sonic/_maps/SS Result Chaos Emeralds.asm"
...
Pal_SSResult:
	incbin	"src/sonic/palette/Special Stage Results.bin"
	even
Art_TitleCard:
	incbin	"src/sonic/artnem/Title Cards.bin"
	even
Art_ResultEm:
	incbin	"src/sonic/artnem/Special Result Emeralds.bin"
	even
Art_Hud:
	incbin	"src/special/data/results_hud.nem"
	even
Art_HudNums:
	incbin	"src/sonic/artunc/HUD Numbers.bin"
	even

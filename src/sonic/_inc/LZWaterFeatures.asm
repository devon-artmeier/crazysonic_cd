...
LZDynamicWater:
		...
		bge.s	.movewater	; if water level is too high, branch
...
LZSlide_Move:
		...
		move.b	Slide_Speeds(pc,d1.w),obInertia(a1)
		clr.b	obInertia+1(a1)
		
		move.b	#id_Walk,obAnim(a1) ; use Sonic's "sliding" animation

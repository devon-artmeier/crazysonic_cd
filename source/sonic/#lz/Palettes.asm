...
Pal_LZ:		incbin	"source/sonic/palette/Labyrinth Zone.bin"
Pal_LZWater:	incbin	"source/sonic/palette/Labyrinth Zone Underwater.bin"
Pal_SBZ3:	incbin	"source/sonic/palette/SBZ Act 3.bin"
Pal_SBZ3Water:	incbin	"source/sonic/palette/SBZ Act 3 Underwater.bin"
Pal_LZSonWater:	incbin	"source/sonic/palette/Sonic - LZ Underwater.bin"
Pal_SBZ3SonWat:	incbin	"source/sonic/palette/Sonic - SBZ3 Underwater.bin"

...
; -------------------------------------------------------------------------
	...
	include	"source/sonic/_inc/Signpost Load.asm"
	include	"source/sonic/_inc/Oscillatory Routines.asm"
	include	"source/sonic/_inc/LZWaterFeatures.asm"
	...
	include	"source/sonic/_inc/Ring Manager.asm"
	...
	include	"source/sonic/_inc/HUD_Update.asm"
	include	"source/sonic/_inc/HUD (part 2).asm"
...
; -------------------------------------------------------------------------
	...
	include	"source/sonic/_incObj/03 Collision Switcher.asm"
Map_Bri:
	include	"source/sonic/_maps/Bridge.asm"
Map_Swing_GHZ:
	include	"source/sonic/_maps/Swinging Platforms (GHZ).asm"
Map_Swing_SLZ:
	include	"source/sonic/_maps/Swinging Platforms (SLZ).asm"
	include	"source/sonic/_incObj/18 Platforms.asm"
Map_GBall:
	include	"source/sonic/_maps/GHZ Ball.asm"
Map_BBall:
	include	"source/sonic/_maps/Big Spiked Ball.asm"
Map_Plat_GHZ:
	include	"source/sonic/_maps/Platforms (GHZ).asm"
Map_Plat_SYZ:
	include	"source/sonic/_maps/Platforms (SYZ).asm"
Map_Plat_SLZ:
	include	"source/sonic/_maps/Platforms (SLZ).asm"
Map_Ledge:
	include	"source/sonic/_maps/Collapsing Ledge.asm"
Map_CFlo:
	include	"source/sonic/_maps/Collapsing Floors.asm"
Map_MBlock:
	include	"source/sonic/_maps/Moving Blocks (MZ and SBZ).asm"
Map_MBlockLZ:
	include	"source/sonic/_maps/Moving Blocks (LZ).asm"
	include	"source/sonic/_incObj/71 Invisible Barriers.asm"
Map_Invis:
	include	"source/sonic/_maps/Invisible Barriers.asm"
	include	"source/sonic/_incObj/1C Scenery.asm"
Map_Scen:
	include	"source/sonic/_maps/Scenery.asm"
	include	"source/sonic/_incObj/24, 27 & 3F Explosions.asm"
	include	"source/sonic/_maps/Explosions.asm"
Map_MisDissolve:
	include	"source/sonic/_maps/Buzz Bomber Missile Dissolve.asm"
	include	"source/sonic/_incObj/28 Animals.asm"
	include	"source/sonic/_incObj/29 Points.asm"
Map_Animal1:
...
Map_Poi:
	include	"source/sonic/_maps/Points.asm"
	include	"source/sonic/_incObj/36 Spikes.asm"
Map_Spike:
	include	"source/sonic/_maps/Spikes.asm"
	include	"source/sonic/_incObj/41 Springs.asm"
	include	"source/sonic/_anim/Springs.asm"
Map_Spring:
	include	"source/sonic/_maps/Springs.asm"
	include	"source/sonic/_incObj/26 Monitor.asm"
	include	"source/sonic/_incObj/2E Monitor Content Power-Up.asm"
	include	"source/sonic/_incObj/26 Monitor (SolidSides subroutine).asm"
	include	"source/sonic/_anim/Monitor.asm"
Map_Monitor:
	include	"source/sonic/_maps/Monitor.asm"
	include	"source/sonic/_incObj/25 & 37 Rings.asm"
	include	"source/sonic/_incObj/4B Giant Ring.asm"
	include	"source/sonic/_incObj/7C Ring Flash.asm"
	include	"source/sonic/_anim/Rings.asm"
Map_Ring:
	include	"source/sonic/_maps/Rings.asm"
Map_GRing:
	include	"source/sonic/_maps/Giant Ring.asm"
Map_Flash:
	include	"source/sonic/_maps/Ring Flash.asm"
	include	"source/sonic/_incObj/0D Signpost.asm"
	include	"source/sonic/_anim/Signpost.asm"
Map_Sign:
	include	"source/sonic/_maps/Signpost.asm"
	include	"source/sonic/_incObj/7D Hidden Bonuses.asm"
Map_Bonus:
	include	"source/sonic/_maps/Hidden Bonuses.asm"
	include	"source/sonic/_incObj/79 Lamppost.asm"
Map_Lamp:
	include	"source/sonic/_maps/Lamppost.asm"
	include	"source/sonic/_incObj/Boss Functions.asm"
	include	"source/sonic/_anim/Eggman.asm"
Map_Eggman:
	include	"source/sonic/_maps/Eggman.asm"
Map_BossItems:
	include	"source/sonic/_maps/Boss Items.asm"
	include	"source/sonic/_incObj/3E Prison Capsule.asm"
	include	"source/sonic/_anim/Prison Capsule.asm"
Map_Pri:
	include	"source/sonic/_maps/Prison Capsule.asm"
	include	"source/sonic/_incObj/34 Title Cards.asm"
Map_Over:
	include	"source/sonic/_maps/Game Over.asm"
	include	"source/sonic/_incObj/3A Got Through Card.asm"
Map_HUD:
	include	"source/sonic/_maps/HUD.asm"
Map_SBall:
	include	"source/sonic/_maps/Spiked Ball and Chain (SYZ).asm"
Map_SBall2:
	include	"source/sonic/_maps/Spiked Ball and Chain (LZ).asm"
...
Nem_Eggman:
	incbin	"source/sonic/artnem/Boss - Main.bin"
	even
Nem_Weapons:
	incbin	"source/sonic/artnem/Boss - Weapons.bin"
	even
Nem_Prison:
	incbin	"source/sonic/artnem/Prison Capsule.bin"
	even
Nem_Exhaust:
	incbin	"source/sonic/artnem/Boss - Exhaust Flame.bin"
	even
Nem_Bomb:
	incbin	"source/sonic/artnem/Enemy Bomb.bin"
	even
Nem_SlzSpike:
	incbin	"source/sonic/artnem/SLZ Little Spikeball.bin"
	even
Nem_TitleCard:
	incbin	"source/sonic/artnem/Title Cards.bin"
	even
Nem_Hud:
	incbin	"source/sonic/artnem/HUD.bin"	; HUD (rings, time, score)
	even
Nem_Lives:
	incbin	"source/sonic/artnem/HUD - Life Counter Icon.bin"
	even
Nem_Ring:
	incbin	"source/sonic/artnem/Rings.bin"
	even
Nem_Monitors:
	incbin	"source/sonic/artnem/Monitors.bin"
	even
Nem_Explode:
	incbin	"source/sonic/artnem/Explosion.bin"
	even
Nem_Points:
	incbin	"source/sonic/artnem/Points.bin"	; points from destroyed enemy or object
	even
Nem_HSpring:
	incbin	"source/sonic/artnem/Spring Horizontal.bin"
	even
Nem_VSpring:
	incbin	"source/sonic/artnem/Spring Vertical.bin"
	even
Nem_SignPost:
	incbin	"source/sonic/artnem/Signpost.bin"	; end of level signpost
	even
Nem_Lamp:
	incbin	"source/sonic/artnem/Lamppost.bin"
	even
Nem_BigFlash:
	incbin	"source/sonic/artnem/Giant Ring Flash.bin"
	even
Nem_Bonus:
	incbin	"source/sonic/artnem/Hidden Bonuses.bin" ; hidden bonuses at end of a level
	even
Nem_Spikes:
	incbin	"source/sonic/artnem/Spikes.bin"
	even
Art_HudNums:
	incbin	"source/sonic/artunc/HUD Numbers.bin" ; 8x16 pixel numbers on HUD
	even
Art_LivesNums:
	incbin	"source/sonic/artunc/Lives Counter Numbers.bin" ; 8x8 pixel numbers on lives counter
	even
Art_Text:
	incbin	"source/sonic/artunc/menutext.bin" ; text used in level select and debug mode
	even
...
Art_GameOver:
	incbin	"source/sonic/gameover/VRAM.nem"
	even
Pal_GameOver:
	incbin	"source/sonic/gameover/CRAM.bin"
	even
VDP_GameOver:
	incbin	"source/sonic/gameover/VDP.bin"
	even

...
PSG_Index:
		...
		dc.l PSG4, PSG5, PSG6
		dc.l PSG7, PSG8, PSG9
PSG1:		incbin	"src/sound/psg/psg1.bin"
PSG2:		incbin	"src/sound/psg/psg2.bin"
PSG3:		incbin	"src/sound/psg/psg3.bin"
PSG4:		incbin	"src/sound/psg/psg4.bin"
PSG6:		incbin	"src/sound/psg/psg6.bin"
PSG5:		incbin	"src/sound/psg/psg5.bin"
PSG7:		incbin	"src/sound/psg/psg7.bin"
PSG8:		incbin	"src/sound/psg/psg8.bin"
PSG9:		incbin	"src/sound/psg/psg9.bin"
...
SpecSoundIndex:
		dc.l SoundD0
SoundA0:	incbin	"src/sound/sfx/SndA0 - Jump.bin"
		even
SoundA1:	incbin	"src/sound/sfx/SndA1 - Lamppost.bin"
		even
SoundA2:	incbin	"src/sound/sfx/SndA2.bin"
		even
SoundA3:	incbin	"src/sound/sfx/SndA3 - Death.bin"
		even
SoundA4:	incbin	"src/sound/sfx/SndA4 - Skid.bin"
		even
SoundA5:	incbin	"src/sound/sfx/SndA5.bin"
		even
SoundA6:	incbin	"src/sound/sfx/SndA6 - Hit Spikes.bin"
		even
SoundA7:	incbin	"src/sound/sfx/SndA7 - Push Block.bin"
		even
SoundA8:	incbin	"src/sound/sfx/SndA8 - SS Goal.bin"
		even
SoundA9:	incbin	"src/sound/sfx/SndA9 - SS Item.bin"
		even
SoundAA:	incbin	"src/sound/sfx/SndAA - Splash.bin"
		even
SoundAB:	incbin	"src/sound/sfx/SndAB.bin"
		even
SoundAC:	incbin	"src/sound/sfx/SndAC - Hit Boss.bin"
		even
SoundAD:	incbin	"src/sound/sfx/SndAD - Get Bubble.bin"
		even
SoundAE:	incbin	"src/sound/sfx/SndAE - Fireball.bin"
		even
SoundAF:	incbin	"src/sound/sfx/SndAF - Shield.bin"
		even
SoundB0:	incbin	"src/sound/sfx/SndB0 - Saw.bin"
		even
SoundB1:	incbin	"src/sound/sfx/SndB1 - Electric.bin"
		even
SoundB2:	incbin	"src/sound/sfx/SndB2 - Drown Death.bin"
		even
SoundB3:	incbin	"src/sound/sfx/SndB3 - Flamethrower.bin"
		even
SoundB4:	incbin	"src/sound/sfx/SndB4 - Bumper.bin"
		even
SoundB5:	incbin	"src/sound/sfx/SndB5 - Ring.bin"
		even
SoundB6:	incbin	"src/sound/sfx/SndB6 - Spikes Move.bin"
		even
SoundB7:	incbin	"src/sound/sfx/SndB7 - Rumbling.bin"
		even
SoundB8:	incbin	"src/sound/sfx/SndB8.bin"
		even
SoundB9:	incbin	"src/sound/sfx/SndB9 - Collapse.bin"
		even
SoundBA:	incbin	"src/sound/sfx/SndBA - SS Glass.bin"
		even
SoundBB:	incbin	"src/sound/sfx/SndBB - Door.bin"
		even
SoundBC:	incbin	"src/sound/sfx/SndBC - Teleport.bin"
		even
SoundBD:	incbin	"src/sound/sfx/SndBD - ChainStomp.bin"
		even
SoundBE:	incbin	"src/sound/sfx/SndBE - Roll.bin"
		even
SoundBF:	incbin	"src/sound/sfx/SndBF - Get Continue.bin"
		even
SoundC0:	incbin	"src/sound/sfx/SndC0 - Basaran Flap.bin"
		even
SoundC1:	incbin	"src/sound/sfx/SndC1 - Break Item.bin"
		even
SoundC2:	incbin	"src/sound/sfx/SndC2 - Drown Warning.bin"
		even
SoundC3:	incbin	"src/sound/sfx/SndC3 - Giant Ring.bin"
		even
SoundC4:	incbin	"src/sound/sfx/SndC4 - Bomb.bin"
		even
SoundC5:	incbin	"src/sound/sfx/SndC5 - Cash Register.bin"
		even
SoundC6:	incbin	"src/sound/sfx/SndC6 - Ring Loss.bin"
		even
SoundC7:	incbin	"src/sound/sfx/SndC7 - Chain Rising.bin"
		even
SoundC8:	incbin	"src/sound/sfx/SndC8 - Burning.bin"
		even
SoundC9:	incbin	"src/sound/sfx/SndC9 - Hidden Bonus.bin"
		even
SoundCA:	incbin	"src/sound/sfx/SndCA - Enter SS.bin"
		even
SoundCB:	incbin	"src/sound/sfx/SndCB - Wall Smash.bin"
		even
SoundCC:	incbin	"src/sound/sfx/SndCC - Spring.bin"
		even
SoundCD:	incbin	"src/sound/sfx/SndCD - Switch.bin"
		even
SoundCE:	incbin	"src/sound/sfx/SndCE - Ring Left Speaker.bin"
		even
SoundCF:	incbin	"src/sound/sfx/SndCF - Signpost.bin"
		even
SoundD0:	incbin	"src/sound/sfx/SndD0 - Waterfall.bin"
		even

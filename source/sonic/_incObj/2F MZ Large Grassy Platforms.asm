...
loc_B0C6:
		out_of_range.w	.delete,lgrass_origX(a0)
		jmp	DisplaySprite
...
; ---------------------------------------------------------------------------
LGrass_Data1:	incbin	"source/sonic/misc/mz_pfm1.bin"
		even
LGrass_Data2:	incbin	"source/sonic/misc/mz_pfm2.bin"
		even
LGrass_Data3:	incbin	"source/sonic/misc/mz_pfm3.bin"
		even
